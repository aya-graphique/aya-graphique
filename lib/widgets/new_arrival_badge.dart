...
/// Badge for freshly added products. Gets its own identity (moving
/// gradient sheen in the brand's violet/orchid tones + a small twinkling
/// sparkle) so "just landed" products actually catch the eye while
/// scrolling the grid, instead of blending in as just another colored
/// label.
