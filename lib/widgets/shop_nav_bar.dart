...
class ShopNavDrawer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // specifically (not Navigator.pop()), since Navigator.pop() pops
    // whatever is topmost on the whole Navigator stack, which could be
    // some other pushed screen entirely rather than this drawer.
    // closeDrawer() only ever touches this drawer, so it can't collide
    // with anything else.
