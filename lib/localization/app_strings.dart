...
class AppText {
  ...
  String get heroWelcomeSubtitle =>
      _t("Aya Attia Abed is an Egyptian Arab advertising and visual identity designer and illustrator with a Bachelor of Applied Arts in the Advertising Department and founder of the personal brand Aya's Graphique for commercial design services and the sale of hand-drawn products.","آية عطية عابد؛ مصممة إعلانات وهويات بصرية ورسامة مصرية عربية حاصلة على بكالريوس الفنون التطبيقية لقسم الإعلان ومؤسسة للعلامة التجارية الشخصية Aya's Graphique لخدمات التصميم التجاري ولبيع المنتجات المرسومة يدوياً.");
