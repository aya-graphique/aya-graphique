...
class StorageService {
  ...
  // No resizing/re-encoding here anymore — banner photos upload exactly as
  // provided. The owner is expected to compress/size them before upload if
  // needed. (Previously this ran through _shrinkForBanner, which capped
  // width at 1600px and re-encoded as JPEG quality 85 — that was causing
  // visible quality loss, so it's been removed.)
