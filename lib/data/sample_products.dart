...
final List<Product> sampleProducts = [
  const Product(
    ...
    imageUrl: 'https://picsum.photos/seed/carnet-classic-1/800/1000',
  ...
  const Product(
    ...
    price: 20.0,
    category: 'Dot Grid',
    imageUrl: 'https://picsum.photos/seed/carnet-dot-1/800/1000',
    tags: ['dot-grid', 'bujo'],
    rating: 4.8,
    stock: 30,
    sortOrder: 1,
  ...
  const Product(
    ...
    price: 26.0,
    category: 'Planners',
    imageUrl: 'https://picsum.photos/seed/carnet-planner-1/800/1000',
  ...
  const Product(
    ...
    imageUrl: 'https://picsum.photos/seed/carnet-kraft-1/800/1000',
  ...
  const Product(
    ...
    imageUrl: 'https://picsum.photos/seed/carnet-premium-1/800/1000',
  ...
  const Product(
    ...
    imageUrl: 'https://picsum.photos/seed/carnet-kids-1/800/1000',
    tags: ['kids', 'set-of-3'],
    rating: 4.9,
    stock: 33,
    sortOrder: 5,
  ...
  const Product(
    ...
    price: 22.0,
    category: 'Classic Ruled',
    imageUrl: 'https://picsum.photos/seed/carnet-classic-2/800/1000',
  ...
  const Product(
    ...
    price: 24.0,
    category: 'Dot Grid',
    imageUrl: 'https://picsum.photos/seed/carnet-dot-2/800/1000',
  ...
  const Product(
    ...
    price: 28.0,
    category: 'Planners',
    imageUrl: 'https://picsum.photos/seed/carnet-planner-2/800/1000',
    tags: ['planner', 'dated'],
    rating: 4.6,
    stock: 15,
    sortOrder: 8,
  ...
  const Product(
    ...
    price: 16.0,
    category: 'Kraft & Recycled',
    imageUrl: 'https://picsum.photos/seed/carnet-kraft-2/800/1000',
  ...
  const Product(
    ...
    price: 64.0,
    category: 'Premium Leather',
    imageUrl: 'https://picsum.photos/seed/carnet-premium-2/800/1000',
  ...
  const Product(
    ...
    price: 13.0,
    category: 'Kids & Sketch',
    imageUrl: 'https://picsum.photos/seed/carnet-kids-2/800/1000',
    tags: ['kids', 'sketch'],
    rating: 4.7,
    stock: 27,
    sortOrder: 11,
